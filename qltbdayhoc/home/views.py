...
def checkGioMuon(): 
    ...
    for x in borrowReturn:
        if "-" in x.giaovien:
            ...
            dateNow = "2023-12-21" # test thời gian
    ...
    for x in listls:
        ...
        dateNow = "2023-12-21 08:25:00" # test thời gian
...
def checkSLM(deviceId,tietm,ngaym): #lấy lúc mình bấm mượn
    dateNow =str(timeVietnam("no"))
    dateNow = "2023-12-21 08:25:00" #test thời gian có thêm cái này nếu muôn ét tg thì mở lên nah cô 
